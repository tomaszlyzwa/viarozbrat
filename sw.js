...
self.addEventListener("fetch", e => {
  ...
  /* 1. Manifest galerii — zawsze z sieci, żeby nowe zdjęcia były widoczne od razu */
  ...
  /* 2. Wywołania API GitHuba (panel admina) — nigdy nie cache'ujemy */
  if (url.hostname === "api.github.com") return;

  /* 3. Zdjęcia galerii i fonty — cache-first (nie zmieniają się) */
  ...
  /* 4. Nawigacja i reszta powłoki — network-first, offline z cache */
